...
static void drawLine_(f32 x0, f32 y0, f32 x1, f32 y1, f32 z, u8 uWidth,
                      GXColor &rColor)
{
	static f32 const cubeScale ATTR_UNUSED = 1.0f;
...
bool Manager::update(int i, f32 x, f32 y, byte4_t uTrigFlag, byte4_t uHoldFlag,
                     byte4_t uReleaseFlag, void *pData)
{
	bool bTouched = false;
...
void PaneComponent::draw()
{
	...
	nw4hbm::math::VEC3 const &translate ATTR_UNUSED = mpPane->GetTranslate();
