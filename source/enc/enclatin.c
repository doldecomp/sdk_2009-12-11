...
// I hope implementations let me do this instead of immediately dying later
#undef ESA
#undef EPA
...
#define DEFINE_PRIVATE_TRAMPOLINE_TO_UTF16(src_, table_)					\
	ENCResult ENCiConvertString ## src_ ## ToUnicode(						\
		char16_t *dst, s32 *dstSize, byte_t const *src, s32 *srcSize,		\
		ENCBreakType breakType)												\
	{																		\
		return ENCiConvertStringLatinToUnicode(dst, dstSize, src, srcSize,	\
											   breakType, table_);			\
	}
...
#define DEFINE_PRIVATE_TRAMPOLINE_FROM_UTF16(dst_, table_)					\
	ENCResult ENCiConvertStringUnicodeTo ## dst_(							\
		...
		ENCBreakType breakType)												\
	{																		\
		return ENCiConvertStringUnicodeToLatin(dst, dstSize, src, srcSize,	\
											   breakType, table_);			\
	}
...
static unsigned char ENCiGetLatinCharFromHashTable(
	struct latin_hash_table_entry const *table, char16_t src);
...
// I guess they kinda hate this one huh
...
struct latin_hash_table_entry const unicode_latin1_array[] =
{
...
struct latin_hash_table_entry const unicode_latin2_array[] =
{
...
struct latin_hash_table_entry const unicode_latin3_array[] =
{
	{ PAD, 0x80,    0}, { HOP, 0x81,    1}, { BPH, 0x82,    2}, { NBH, 0x83,    3},
	{ IND, 0x84,    4}, { NEL, 0x85,    5}, { SSA, 0x86,    6}, { ESA, 0x87,    7},
...
struct latin_hash_table_entry const unicode_greek_array[] =
{
	{ PAD, 0x80,    0}, { HOP, 0x81,    1}, { BPH, 0x82,    2}, { NBH, 0x83,    3},
...
struct latin_hash_table_entry const unicode_latin6_array[] =
{
...
struct latin_hash_table_entry const unicode_latin9_array[] =
{
	{ PAD, 0x80,    0}, { HOP, 0x81,    1}, { BPH, 0x82,    2}, { NBH, 0x83,    3},
	{ IND, 0x84,    4}, { NEL, 0x85,    5}, { SSA, 0x86,    6}, { ESA, 0x87,    7},
	{ HTS, 0x88,    8}, { HTJ, 0x89,    9}, { LTS, 0x8A,   10}, { PLD, 0x8B,   11},
...
struct latin_hash_table_entry const unicode_win1252_array[] =
{
...
struct latin_hash_table_entry const unicode_win1250_array[] ATTR_UNUSED =
{
...
struct latin_hash_table_entry const unicode_win1253_array[] ATTR_UNUSED =
{
...
struct latin_hash_table_entry const unicode_macroman_array[] ATTR_UNUSED =
{
...
struct latin_hash_table_entry const unicode_macgreek_array[] ATTR_UNUSED =
{
...
struct latin_hash_table_entry const unicode_macce_array[] ATTR_UNUSED =
{
...
struct latin_hash_table_entry const unicode_ibm850_array[] ATTR_UNUSED =
{
...
struct latin_hash_table_entry const unicode_ibm852_array[] ATTR_UNUSED =
{
