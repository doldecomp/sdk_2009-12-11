...
{
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:HBMController.o(1)::.debug_info::0x413 [original object]
	class Controller
	{
	// nested types
	public:
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:HBMController.o(1)::.debug_info::0x547 [original object]
		struct HBController
		{
	...
	public:
		...
		WPADResult getInfoAsync(WPADInfo *info);
	...
	private:
		...
		WPADConnectCallback		*mOldExtensionCallback;		// size 0x04, offset 0x28 // TODO: Check DWARF on this
		/* 4 bytes padding */
