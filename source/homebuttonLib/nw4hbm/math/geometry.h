...
{
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x97d [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x821 [original object]
	struct SEGMENT3
	{
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x7eb [original object]
	struct RAY3
	{
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x784 [original object]
	struct LINE3
	{
	// methods
	public:
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0xb77 [original object]
	struct CAPSULE
	{
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x102 [original object]
	struct PLANE
	{
	// methods
	public:
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x229 [original object]
	struct AABB
	{
	// methods
	public:
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x5a8 [original object]
	struct SPHERE
	{
	// methods
	public:
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:math_geometry.o(1)::.debug_info::0x604 [original object]
	class FRUSTUM
	{
	// methods
	public:
		...
		void Set(f32 top, f32 bottom, f32 left, f32 right, f32 n, f32 f,
		         MTX34 const &camera);
	...
	f32 DistSqLine3ToSegment3(LINE3 const *L0, SEGMENT3 const *S, f32 *s,
	                          f32 *t);
	...
	IntersectionResult IntersectionLine3Plane(LINE3 const *L, PLANE const *J,
	                                          f32 *t, VEC3 *I);
	IntersectionResult IntersectionRay3Plane(RAY3 const *R, PLANE const *J,
	                                         f32 *t, VEC3 *I);
	IntersectionResult IntersectionSegment3Plane(
		SEGMENT3 const *S, PLANE const *J, f32 *t, VEC3 *I);
	IntersectionResult IntersectionLine3Sphere(
		LINE3 const *L, SPHERE const *sphere, f32 *t0, f32 *t1);
	IntersectionResult IntersectionRay3Sphere(
		RAY3 const *R, SPHERE const *sphere, f32 *t0, f32 *t1);
	bool IntersectionRay3Sphere(RAY3 const *R, SPHERE const *sphere);
	IntersectionResult IntersectionSegment3Sphere(
		SEGMENT3 const *S, SPHERE const *sphere, f32 *t0, f32 *t1);
