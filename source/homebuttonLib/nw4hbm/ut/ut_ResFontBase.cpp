...
// [SC5PGN]/build/libs/Debug/slamWiiD.a:ut_ResFontBase.o(1)::.debug_info::0xa65 [original object]
...
// [SC5PGN]/build/libs/Debug/slamWiiD.a:ut_ResFontBase.o(1)::.debug_info::0xaa6 [original object]
struct CMapInfoScan
{
...
ResFontBase::GlyphIndex ResFontBase::GetGlyphIndex(char16_t c) const
{
	GlyphIndex index = FindGlyphIndex(c);
...
ResFontBase::GlyphIndex ResFontBase::FindGlyphIndex(char16_t c) const
{
	FontCodeMap *pMap;
