...
namespace nw4hbm { namespace lyt
{
	namespace res
	{
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_textBox.o(1)::.debug_info::0x11dc [original object]
		struct Font
		{
		...
		static byte4_t const SIGNATURE_TEXT_BOX_BLOCK =
			NW4HBM_FOUR_CHAR('t', 'x', 't', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_textBox.o(1)::.debug_info::0xdce [original object]
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_textBox.o(1)::.debug_info::0x359 [original object]
	...
	public:
		...
		TextBox(u16 allocStrLen, wchar_t const *str, u16 strLen,
		        ut::Font const *pFont);
	...
	private:
		...
		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_textBox.o(1)::.debug_info::0xd71 [original object]
