...
namespace nw4hbm { namespace lyt
{
	namespace res
	{
		static byte4_t const SIGNATURE_GROUP_BLOCK =
			NW4HBM_FOUR_CHAR('g', 'r', 'p', '1');

		static byte4_t const SIGNATURE_GROUP_BLOCK_START =
			NW4HBM_FOUR_CHAR('g', 'r', 's', '1');
		static byte4_t const SIGNATURE_GROUP_BLOCK_END =
			NW4HBM_FOUR_CHAR('g', 'r', 'e', '1');

		// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_group.o(1)::.debug_info::0x2ca [original object]
		struct Group
		{
		// static members
		public:
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_group.o(1)::.debug_info::0x131 [original object]
	class Group
	{
	// typedefs
	public:
	...
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_group.o(1)::.debug_info::0xe28 [original object]
