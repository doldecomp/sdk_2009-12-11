...
#define DEFINE_PUBLIC_ENC_TRAMPOLINE_WITH_GIVEN_MB_STATE(srcEnc_, srcChar_, dstEnc_,	\
												   dstChar_, mbState_)			\
	DEFINE_PUBLIC_ENC_TRAMPOLINE_WITH_GIVEN_MB_STATE_VIA(srcEnc_, srcChar_, srcEnc_,	\
												   dstEnc_, dstChar_, dstEnc_,	\
												   mbState_)
 ...
 * of a conversion function to declare shit
 */
// NOTE: Does not swallow semicolon. Do not feed it one
// NOTE: Not to be confused with multi-byte state, which is different.
