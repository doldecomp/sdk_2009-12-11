...
namespace
{
	...
	void CalcIndTexMtx(Mtx23Ptr mtx, TexSRT const &texSRT);
	...
	void SetIndTexMtx(GXIndTexMtxID id, CMtx23Ptr mtx);
...
void SetIndTexMtx(GXIndTexMtxID id, CMtx23Ptr mtx)
{
	 ...
	 * [SC5PGN]/build/libs/Debug/slamWiiD.a:lyt_material.o(1)::.debug_info::0x4031 [original object]
