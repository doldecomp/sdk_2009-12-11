...
#define ENC_UTF7_STATE_COLLECT(partialBits_, partialOffset_)	\
	(ENC_UTF7_STATE_BASE64_MODE | ((partialBits_) & 0xfffc0000)	\
	 | ((partialOffset_) >> 1 & 0x00000007l)) // ?

typedef ENCMBState ENCUTF16State;
enum ENCUtf16State_et
{
...
DECLARE_PRIVATE_ENC_FUNCTION(Utf32, char32_t, Utf16, char16_t)
DECLARE_PRIVATE_ENC_FUNCTION(Utf16, char16_t, Utf32, char32_t)
DECLARE_PRIVATE_ENC_FUNCTION(Utf32, char32_t, Utf8, char8_t)
DECLARE_PRIVATE_ENC_FUNCTION(Utf8, char8_t, Utf32, char32_t)
DECLARE_PRIVATE_ENC_FUNCTION(Utf16, char16_t, Utf8, char8_t)
DECLARE_PRIVATE_ENC_FUNCTION(Utf8, char8_t, Utf16, char16_t)
DECLARE_PRIVATE_ENC_FUNCTION_WITH_MB_STATE(Utf7, byte_t, Utf16, char16_t)
DECLARE_PRIVATE_ENC_FUNCTION_WITH_MB_STATE(Utf16, char16_t, Utf16, char16_t)
