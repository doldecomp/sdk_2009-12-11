...
{
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:ut_TextWriterBase.o(1)::.debug_info::0x1ee, 0xb7a... [original object]
	...
	public:
		...
		void CalcVStringRect(Rect *pRect, CharT const *format,
		...
		static int VSNPrintf(char *buffer, u32 count, char const *format,
		                     std::va_list arg)
		{
		...
		f32 AdjustCursor(f32 *xOrigin, f32 *yOrigin, CharT const *str,
		                 int length);
	...
	private:
		...
		byte4_t					mDrawFlag;		// size 0x04, offset 0x58
