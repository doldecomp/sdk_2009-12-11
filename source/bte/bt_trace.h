...
#define HIDD_TRACE(type_, ...)	do { if (hd_cb.trace_level >= BT_TRACE_LEVEL_ ## type_) BLUEDROID_LOG_TRACE(GENERAL, HIDD, STACK, type_, __VA_ARGS__); } while (FALSE)
