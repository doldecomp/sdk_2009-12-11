...
{
	// [SC5PGN]/build/libs/Debug/slamWiiD.a:ut_ResFontBase.o(1)::.debug_info::0x1df [original object]
	...
	public:
		...
		// methods
		GlyphIndex GetGlyphIndex(char16_t c) const;
		...
		GlyphIndex FindGlyphIndex(char16_t c) const;
		GlyphIndex FindGlyphIndex(FontCodeMap const *pMap, char16_t c) const;
